...
public class ExcelDataProviderHelper {

        public static void main(String[] args)
        {
            // You can specify your excel file path.
            String excelFilePath = ApplicationProperties.TESTDATA_DIR.getStringVal()+"CSR_PlanValidation_TestData.xls";
           ...
           // readJsonObjectsFromFile(excelFilePath.replace(".xls", ".xls.json"));
            Object[][] excelDataRowObjects= ExcelDataProviderHelper.convertExcelDataToObjectArray(excelFilePath, "csr");
